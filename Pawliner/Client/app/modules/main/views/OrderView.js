...
], function (B, $, marionette, template, OrderRespondsCollectionView, OrderPhotosCollectionView, CreateRespondBlock, AddPhotosBlock, EditOrderBlock, Orders, Photo, Respond) {
    'use strict';
    return marionette.View.extend({
        ...
        onRender: function () {
            ...
            if (window.app.model.get('userId') === this.model.get('UserId')) {
                ...
                this.showChildView('addPhotosBlock', new AddPhotosBlock({model: this.model}));
            }
